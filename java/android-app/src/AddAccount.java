...
public class AddAccount extends Activity
{
	...
	public void addAccount(View v)
	{
		...
		EditText editIBAN = (EditText) this.findViewById(R.id.editIBAN);
		EditText editBIC = (EditText) this.findViewById(R.id.editBIC);
		...
		try
		{
			...
			values.put(Database.ACCOUNTS_IBAN, editIBAN.getText().toString());
			values.put(Database.ACCOUNTS_BIC, editBIC.getText().toString());
